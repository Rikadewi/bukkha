...
<style>   
    .one {
        background-image: url('../img/house/3/front.jpg');
    }
    .two {
        background-image: url('../img/house/3/1.jpg');
    }
    .three {
        background-image: url('../img/house/3/2.jpg');
    }
    .four {
        background-image: url('../img/house/3/3.jpg');
    }
</style>
@endsection
